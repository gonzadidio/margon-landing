...
export default function Hero() {
  return (
    <section className="relative overflow-hidden hero-grid-bg">
      ...
      <div className="relative z-10 mx-auto max-w-[1500px] px-5 sm:px-8 lg:px-12 pt-24 lg:pt-28 pb-16 w-full">
        <HeroHeading />

        {/* Proceso: 01 — 02 — 03 */}
        <div className="hero-process animate-fade-up" style={{ animationDelay: '0.2s' }}>
          <ProcessIdea />
          <div className="hero-connector hero-connector-red" aria-hidden="true" />
          <ProcessDevelopment />
